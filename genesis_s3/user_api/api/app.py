...
from genesis_s3.common.api.middlewares import errors as errors_mw
from genesis_s3.user_api.api import routes as app_routes
...
def get_openapi_engine():
    openapi_engine = openapi_engines.OpenApiEngine(
        info=openapi_structures.OpenApiInfo(
            title=f"Genesis S3 {versions.API_VERSION_1_0} User API",
            version=app_version.version_info,
            description=(f"OpenAPI - Genesis S3 {versions.API_VERSION_1_0}"),
        ),
