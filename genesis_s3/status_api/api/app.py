...
from genesis_s3.status_api.api import routes as app_routes
from genesis_s3.status_api.api import versions
from genesis_s3 import version
...
def get_openapi_engine():
    openapi_engine = openapi_engines.OpenApiEngine(
        info=openapi_structures.OpenApiInfo(
            title=f"Genesis S3 {versions.API_VERSION_v1} Status API",
            version=version.version_info,
            description=f"OpenAPI - Genesis S3 {versions.API_VERSION_v1}",
        ),
