...
from exordos_s3.status_api.api import routes as app_routes
from exordos_s3.status_api.api import versions
...
def get_openapi_engine():
    openapi_engine = openapi_engines.OpenApiEngine(
        info=openapi_structures.OpenApiInfo(
            title=f"Exordos S3 {versions.API_VERSION_v1} Status API",
            version=version.version_info,
            description=f"OpenAPI - Exordos S3 {versions.API_VERSION_v1}",
        ),
