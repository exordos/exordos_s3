...
Grafana элемента observability: заполненность диска по нодам, место под
объекты, состояние дисков и трафик запросов, с выбором проекта и инстанса.
Зависит от элемента `observability`, ставить после него.
...
- **Латентность запросов — только средняя.** RustFS 1.0.0-beta.4 раскладывает
